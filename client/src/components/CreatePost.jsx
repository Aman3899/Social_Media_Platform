    ...
    return (
        <div className="postDiv">
            ...
            <div className="dragDropArea" onDragOver={handleDragOver} onDrop={handleDrop}>
                ...
                <svg aria-label="Icon to represent media such as images or videos" className="icon" fill="currentColor" height="125" role="img" viewBox="0 0 97.6 77.3" width="96">
                ...
                <label htmlFor="post" className="fileInputLabel">Select from computer</label>
